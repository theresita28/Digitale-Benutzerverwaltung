...
app.get('/run-python', (req, res) => {
    ...
    const arg4 = req.query.arg4 || ''; // Get fourth argument
    const arg5 = req.query.arg5 || ''; // Get fifth argument
    const pythonFilePath = 'BesucherverMitMail.py'; // Replace with the path to your Python file
    ...
    exec(`python ${pythonFilePath} ${functionName} ${arg1} ${arg2} ${arg3} ${arg4} ${arg5}`, (error, stdout, stderr) => {
        if (error) {
